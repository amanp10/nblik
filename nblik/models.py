...
class UserProfile(models.Model):
    ...
    picture = ProcessedImageField(default='https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-031348677605/images/icon.jpg',upload_to='profile_images',processors=[ResizeToFill(300, 300)],format='JPEG',options={'quality': 90})
