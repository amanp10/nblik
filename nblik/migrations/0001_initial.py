    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_to', models.ForeignKey(to='nblik.Blog')),
            ],
        ),
        migrations.CreateModel(
            name='Company',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.IntegerField(default=0)),
                ('category', models.ForeignKey(to='nblik.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Follow',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followed_tags', models.ManyToManyField(to='nblik.Tag', blank=True)),
                ('liked_blogs', models.ManyToManyField(to='nblik.Blog', blank=True)),
                ('liked_categories', models.ManyToManyField(to='nblik.Category', blank=True)),
                ('liked_comments', models.ManyToManyField(to='nblik.Comment', blank=True)),
                ('liked_discusses', models.ManyToManyField(to='nblik.Discuss', blank=True)),
                ('liked_discussions', models.ManyToManyField(to='nblik.Discussion', blank=True)),
                ('myreading_list', models.ManyToManyField(to='nblik.BlogId', blank=True)),
                ('user', models.OneToOneField(to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='started_by',
            field=models.ForeignKey(to='nblik.UserProfile'),
        ),
        migrations.AddField(
            model_name='discuss',
            name='discuss_by',
        ...
        migrations.AddField(
            model_name='discuss',
            name='discuss_on',
            field=models.ForeignKey(to='nblik.Discussion'),
        ),
        migrations.AddField(
            model_name='blog',
            name='category',
            field=models.ForeignKey(to='nblik.Category'),
        ),
        migrations.AddField(
            model_name='blog',
            name='written_by',
